...
export default {
    ...
    created() {
        axios.get('/bookList.json').then((res) => {
            ...
            if (this.$route.path === '/bookcategory/literature') {
                this.bookData = res.data.bookList.splice(21 * 1, 21)
            } else if (this.$route.path === '/bookcategory/non_fiction') {
                this.bookData = res.data.bookList.splice(21 * 2, 21)
            } else if (this.$route.path === '/bookcategory/education') {
                this.bookData = res.data.bookList.splice(21 * 3, 21)
            } else if (this.$route.path === '/bookcategory/life') {
                this.bookData = res.data.bookList.splice(21 * 4, 21)
            } else if (this.$route.path === '/bookcategory/reference') {
